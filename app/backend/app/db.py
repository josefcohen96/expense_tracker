...
def initialise_database() -> None:
    ...
    cur.execute("""
        CREATE TABLE IF NOT EXISTS wedding_ideas (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            title TEXT NOT NULL,
            description TEXT,
    ...
    # Migration: add meal preference fields to wedding_guests
    try:
        guest_cols = [r[1] for r in cur.execute("PRAGMA table_info('wedding_guests')").fetchall()]
        for col, typedef in [("meal_type", "TEXT DEFAULT 'regular'"), ("food_notes", "TEXT"), ("plus_one_meal_type", "TEXT DEFAULT 'regular'")]:
