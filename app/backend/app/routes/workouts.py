...
SKILL_PROGRESSIONS = {
    ...
    "nordic_curl": {
        "title": "כפיפה נורדית (Nordic Curl)",
        "difficulty": "רמת קושי: בינוני",
        "muscles": "שרירים עיקריים: ירך אחורית (המסטרינג), ישבן, גב תחתון, תאומים",
        "warmup": "זמן חימום מומלץ: 10-15 דקות — אגן, ירך אחורית וברכיים",
        "prereq": "תנאי סף למסלול: 15 גשרי ישבן נקיים ו-10 סקוואט משקל גוף בטווח מלא.",
        "cues": [
            "הירכיים נשארות פשוטות לאורך כל הירידה — קיפול באגן הופך את התרגיל לכיפוף גב במקום עבודת ירך אחורית.",
            "העקבים חייבים להיות נעולים היטב (מוט נמוך, ספה, בן זוג) — עוגן רופף הוא הסיבה הנפוצה לירידה לא מבוקרת.",
            "הידיים הן בלם, לא מנוע: הן תופסות רק בסוף הירידה, ובעלייה דוחפים איתן כמה שפחות.",
            "הירידה האיטית היא התרגיל — 4-5 שניות לפחות; כאב חד מאחורי הברך או בירך פירושו לעצור.",
        ],
        "progressions": [
            _station("Glute Bridge", "גשר ישבן", 15, 60,
                     "שכיבה על הגב עם ברכיים כפופות וכפות רגליים על הרצפה; דוחפים מהעקבים ומרימים את האגן עד קו ישר מהכתפיים לברכיים.",
                     [("דחיפה מהעקבים", "המשקל על העקבים, לא על קצות האצבעות."),
                      ("ישבן נעול למעלה", "שנייה של כיווץ ישבן בנקודה הגבוהה.")]),
            _station("Single-Leg Glute Bridge", "גשר ישבן רגל אחת", 10, 60,
                     "מגשר ישבן מרימים רגל אחת ישרה באוויר ומבצעים את אותה דחיפה על רגל אחת; מחליפים רגל בין הסטים.",
                     [("אגן ישר", "האגן לא מסתובב — שתי עצמות האגן באותו גובה."),
                      ("להחליף צד", "אותו מספר חזרות לכל רגל.")]),
            _station("Sliding Leg Curl", "כפיפת ברכיים בהחלקה", 10, 90,
                     "שכיבה על הגב עם עקבים על מגבת או רצפה חלקה; מרימים אגן, מחליקים את העקבים החוצה עד רגליים ישרות ומושכים חזרה.",
                     [("אגן באוויר", "האגן לא נוגע ברצפה לאורך כל הסט."),
                      ("משיכה מהעקבים", "העקבים מושכים את הגוף חזרה, לא הבטן.")]),
            _station("Nordic Curl Hold", "החזקה נורדית", 15, 90,
                     "כריעה עם עקבים נעולים והגוף בקו ישר מהברכיים לכתפיים; נשענים קדימה עד הנקודה שעדיין שולטים בה ומחזיקים.",
                     [("קו ישר", "ברכיים-אגן-כתפיים בקו אחד, בלי לקפל."),
                      ("לנשום", "נושמים בהחזקה — לא עוצרים את הנשימה.")],
                     unit="sec"),
            _station("Band-Assisted Nordic Curl", "כפיפה נורדית עם גומייה", 6, 120,
                     "גומייה קשורה מלפנים ומוחזקת בחזה או מתחת לבתי השחי; יורדים בשליטה ועולים חזרה כשהגומייה נושאת חלק מהמשקל.",
                     [("גומייה עוזרת", "מדקקים את הגומייה ככל שמתחזקים."),
                      ("ירידה איטית", "4 שניות למטה גם עם הגומייה.")]),
            _station("Nordic Negatives", "ירידה נורדית אקסצנטרית", 5, 120,
                     "מכריעה גבוהה יורדים לאט ככל האפשר עד הרצפה, נוחתים על הידיים ודוחפים חזרה למעלה בעזרתן.",
                     [("ירידה 5 שניות", "לספור לאט — הירידה היא כל העבודה."),
                      ("ידיים בסוף", "הידיים תופסות רק ברגע האחרון.")]),
            _station("Partial Nordic Curl", "כפיפה נורדית בטווח חלקי", 5, 150,
                     "יורדים רק עד הנקודה שממנה עדיין אפשר למשוך חזרה בכוח הירך האחורית בלי הידיים, ומעמיקים את הטווח מסט לסט.",
                     [("בלי ידיים", "עולים חזרה בלי לגעת ברצפה."),
                      ("להעמיק בהדרגה", "כמה מעלות יותר בכל פעם שיוצאות 5 חזרות.")]),
            _station("Nordic Hamstring Curls", "כפיפות ברכיים נורדיות", 5, 180,
                     "ירידה מלאה בשליטה עד שהחזה כמעט נוגע ברצפה, נגיעה קלה של הידיים, ועלייה חזרה למעלה בכוח הירך האחורית.",
                     [("אגן נעול", "ישבן מכווץ וקו ישר מהברכיים לכתפיים."),
...
PATHS = {
    ...
    "nordic_curl": {"name": "כפיפה נורדית", "icon": "🦵", "tint": "rgba(22,163,74,.32)", "unlock_level": 1, "workout_type": "Legs"},
...
TEMPO_BY_EXERCISE = {
    ...
    "Glute Bridge": (2, 1, 1),
    "Single-Leg Glute Bridge": (2, 1, 1),
    "Band-Assisted Nordic Curl": (4, 1, 1),
    "Nordic Negatives": (5, 1, 1),
    "Partial Nordic Curl": (4, 1, 1),
}
...
WARMUPS = {
    ...
    "nordic_curl": [
        {"title": "סיבובי אגן וברכיים", "detail": "20 שניות לכל כיוון"},
        {"title": "נדנודי רגל קדימה-אחורה", "detail": "2 × 10 לכל רגל"},
        {"title": "גשר ישבן קל", "detail": "2 × 10"},
        {"title": "כפיפת ירך אחורית בעמידה (Good Morning) במשקל גוף", "detail": "2 × 10"},
        {"title": "כריעה נורדית קלה — החזקה גבוהה", "detail": "2 × 10 שניות"},
    ],
}
